...
export function PaymentMethodPanel(props: {
  ...
  return (
    <section aria-labelledby="payment-method-title">
      ...
      <button type="button" onClick={props.onContinue} disabled={props.pending} className="premium-action mt-4 flex min-h-11 w-full items-center justify-center rounded-xl bg-[var(--brand)] px-5 text-sm font-semibold text-white disabled:cursor-wait disabled:opacity-60">{presentation.continueLabel}</button>
